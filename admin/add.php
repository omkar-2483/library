...
<div id="main">
  ...
  <div class="container" style="text-align: center;">
    ...
    <form style="color:black;" class="book" action="" method="post">
        ...
        <button style="color:white; font-size: 18px; font-weight: bold;" type="submit" name="submit">ADD</button>
    </form>
  </div>
<?php
    if(isset($_POST['submit']))
    {
      if(isset($_SESSION['login_user']))
      {
        mysqli_query($db,"INSERT INTO books VALUES ('$_POST[bid]', '$_POST[name]', '$_POST[authors]', '$_POST[edition]', '$_POST[status]', '$_POST[quantity]') ;");
        ?>
