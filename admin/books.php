...
function closeNav() {
  ...
  <div class="srch">
    <form class="navbar-form" method="post" name="form1">
      <div>
        <input style="color:black;" type="text" name="search" placeholder="search book.." required="">
    ...
    <form class="navbar-form" method="post" name="form1">
      <div>
        <input style="color:black;" type="text" name="bid" placeholder="Enter Book ID" required="">
  ...
  <h2 style="margin: 0px; font-family: poppins; text-align: center; font-weight: bold; color: wheat;">List Of Books</h2>
  <?php
